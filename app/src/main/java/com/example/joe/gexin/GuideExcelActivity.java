...
/**
 * Created by Joe on 2017/3/19.
 */

public class GuideExcelActivity extends Activity{
    ...
    private void initView() {
        ...
        GuideExcelActivity.GuideAdapter adapter = new GuideExcelActivity.GuideAdapter();
    ...
    private void initData() {
        int[] imageResIDs = {
                R.drawable.guide_excel1,
                R.drawable.guide_excel2,
                R.drawable.guide_excel3,
                R.drawable.guide_excel4
        };
